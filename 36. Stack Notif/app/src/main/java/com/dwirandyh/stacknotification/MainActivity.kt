package com.dwirandyh.stacknotification
...
class MainActivity : AppCompatActivity() {
    ...
    // untuk membedakan notifikasi 1 dengan yang lain
    ...
    private fun sendNotif() {
        ...
        if (idNotification < MAX_NOTIFICATION) {
            ...
            // membuat inputan inbox style dan menambahkannya ke mBuilder
    ...
    /**
     * Ketika ada inten baru (pending intent) yang dikirikam ke activity melalui NotificationManager
     *
     * @param intent
     */
