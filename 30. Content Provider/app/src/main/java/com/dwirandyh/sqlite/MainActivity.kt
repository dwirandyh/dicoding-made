...
import com.dwirandyh.sqlite.helper.MappingHelper
...
class MainActivity : AppCompatActivity() {
    ...
    /*
    Sudah tidak digunakan karena fungsinya sudah digantikan oleh ContentResolver
     */
    ...
    private fun loadNotesAsync() {
        GlobalScope.launch(Dispatchers.Main) {
            ...
            val deferredNotes = async(Dispatchers.IO) {
                ...
                // dengan mengugnakan content resolver
