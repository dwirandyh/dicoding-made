...
class NotificationBroadcastReceiver : BroadcastReceiver() {
    ...
    /**
     * Untuk membaca inputan dari direct message, kita bisa menggunakan remoteinput. kemudian kita menerimanya menggunakan
     * method onReceive
     *
     * @param context
     * @param intent
