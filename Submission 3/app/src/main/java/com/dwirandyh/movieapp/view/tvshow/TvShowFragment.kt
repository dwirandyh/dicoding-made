...
import com.dwirandyh.movieapp.view.movie.MovieFragmentDirections
import com.dwirandyh.movieapp.view.movie.MovieViewModel
...
class TvShowFragment : Fragment() {
    ...
    private fun navigateToMovieDetail(tvShow: TvShow) {
        val directions = TvShowFragmentDirections.actionNavTvShowToTvShowDetailFragment(tvShow)
